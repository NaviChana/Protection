...
namespace Packt.Shared
{
    ...
    {
        // Encryptying symmetrically with AES
        ...
        } // End Encryptying symmetrically with AES
        ...
        } // End Hashing with the commonly used SHA256
            ...
            string data, string signature)
        {
            ...
            return rsa.VerifyHash(hashedData, signatureBytes,
                HashAlgorithmName.SHA256, RSASignaturePadding.Pkcs1);
        } // End Signing with SHA256 and RSA
        ...
        } // End Implementing Authentication and Authorization
    }
}
